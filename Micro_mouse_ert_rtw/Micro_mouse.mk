...
## Generated on : Mon May 19 11:32:02 2025
...
DEFINES_SKIPFORSIL = -DMW_SCHEDULER_PRIORITY=3 -DXCP_CUSTOM_PLATFORM -D__FPU_PRESENT=1U -D__FPU_USED=1U -DSTACK_SIZE=512 -DRT -DHWI_EXTI9_5_IRQHandler -DHWI_EXTI3_IRQHandler -DHWI_EXTI0_IRQHandler
...
mw_stm32_i2c_v2_ll.o : C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/shared/supportpackages/stm32/src/mw_stm32_i2c_v2_ll.c
	$(CC) $(CFLAGS) -o "$@" "$<"
